...
[Live Demo](https://kanban-project-management-trello.vercel.app) · [Features](#-features) · [Architecture](#-architecture-infographic) · [Local setup](#-local-development) · [Deploy](#-deployment-neon--render--vercel) · [Environment](#-environment-variables)
...
[Live Demo](https://kanban-project-management-trello.vercel.app) · [Report issues](https://github.com/Savn-says/Kanban-Project-management-/issues)
